                    ...
                    if (hasRows)
                    {
                        foreach (DataRow drDate in dsDate.Tables[0].Rows)
                        {
                            ...
                            if (hasRows)
                            {
                                ...
                                {
                                    //do-not check if any sanction in/out found. added on 11-01-2020
                            ...
                            if (tInTime > ShiftStart)
                            {
                                ...
                                if (tDiff.TotalSeconds >= Globals.G_LateComeSec)
                                {
                                    ...
                                    if (Globals.G_HFFLG_LateCome)
                                    {
                                        ...
                                        else if (seclate > Globals.G_HFSEC_LateCome && eWrkGrp == "COMP" && eGradeCode > Globals.G_GlobalGradeExclude && drAttd["LeaveTyp"].ToString() == "" && drAttd["Status"].ToString() == "P")
                                        {
                                            drAttd["Halfday"] = 1;
                                            drAttd["GracePeriod"] = "";
                                            drAttd["LateCome"] = sminlate;
                                        ...
                                        else if (seclate > Globals.G_HFSEC_LateCome && eWrkGrp == "COMP" && eGradeCode > Globals.G_GlobalGradeExclude && drAttd["Status"].ToString() == "A")
                                        {
                                            drAttd["Halfday"] = 0;
                                            drAttd["GracePeriod"] = "";
                                            drAttd["LateCome"] = sminlate;
                                        }
                                        else if (seclate > Globals.G_HFSEC_LateCome && drAttd["Status"].ToString() == "P")
                                        {
                                            drAttd["Halfday"] = 1;
                                            drAttd["GracePeriod"] = "";
                                            drAttd["LateCome"] = sminlate;
                            ...
                            if (Convert.ToDateTime(drAttd["ConsOut"]) < ShiftEnd)
                            {
                                ...
                                if (t5.TotalSeconds > (Globals.G_EarlyGoingSec) )
                                {
                                    ...
                                    if (Globals.G_HFFLG_EarlyGoing)
                                    {
                                        ...
                                        else if (secgone > Globals.G_HFSEC_EarlyGoing && eWrkGrp == "CONT")
                                        {
                                            drAttd["Halfday"] = 1;
                                            drAttd["EarlyGoing"] = smingone;
                                            drAttd["GracePeriod"] = "";
